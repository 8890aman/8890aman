...
Python and Java backend systems, APIs, and data pipelines.<br>
React, Vue, or Next.js frontend projects needing clean, production-ready UI.<br>
🤝 I'm looking for help with<br>
Scaling DICOM/PACS infrastructure for higher study volumes.<br>
Advanced Frappe/ERPNext architecture and customization patterns.<br>
Sharpening DSA fundamentals across Python and Java.<br>
Exploring Next.js in more depth for full-stack projects.<br>
🌱 I'm currently learning<br>
Data Structures & Algorithms (Python & Java) — pattern-based practice.<br>
Deeper HL7/DICOM interoperability and imaging workflow concepts.<br>
AWS for scalable healthcare infrastructure and deployment.<br>
Next.js for full-stack React development.<br>
💬 Ask me about<br>
DICOM, HL7, PACS, and healthcare imaging systems.<br>
Frappe/ERPNext development and customization.<br>
Building and deploying production systems with Python, Vue, and Docker.<br>
React, Vue, Java, and C/C++ fundamentals.
